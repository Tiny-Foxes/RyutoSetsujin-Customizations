return Def.ActorFrame {
	--note graphic
	NOTESKIN:LoadActor("Center", "Tap Note") .. {
	...
	--tap
	NOTESKIN:LoadActor("Center", "Ready Receptor")..{
	...
	LoadActor("_flash")..{
		...
		HitMineCommand=function(self) self:playcommand("Glow") end,
		HeldCommand=function(self) self:playcommand("Glow") end,
		GlowCommand=function(self)	self:setstate(0):finishtweening():diffusealpha(1):zoom(0.8):linear(0.2):diffusealpha(0):zoom(1) end,
	},
	--thing...
	Def.Quad {
